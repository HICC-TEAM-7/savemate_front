// src/components/ui/WeekGraph.tsx
import React, { useEffect, useMemo, useState } from "react";
import { ResponsiveContainer, PieChart, Pie, Cell } from "recharts";
import { fetchWeekSpending, type DaySpending } from "../../api/spendingdata";

type Props = {
  /** 외부에서 주간 데이터를 넘기면 그걸 사용, 없으면 내부에서 fetchWeekSpending 호출 */
  data?: DaySpending[];
  /** 기준일(월~일 계산용). data가 없을 때만 사용됨 */
  baseDate?: Date;
  /** 월~오늘까지만 자를지 여부 (기본 true) */
  upToToday?: boolean;
  title?: string;
};
